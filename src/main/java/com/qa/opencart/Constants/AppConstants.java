...
{
	public static final int DEFAULT_MEDIUM_TIME_OUT=20;
	...
	public static final String ACCOUNTPAGE_PAGE_TITLE_VALUE="My Account";
	public static final String ACCOUNTPAGE_PAGE_URL_FRACTIONVALUE="route=account/account";
